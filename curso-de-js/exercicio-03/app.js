...
*/
dogNames.pop();
const lastDogNames = dogNames[dogNames.length - 1];
console.log(lastDogNames);
/*
...
const dessertMessage = `A ${dessert} é um doce à base de coco, tradicional na América Latina e em Angola.`;
